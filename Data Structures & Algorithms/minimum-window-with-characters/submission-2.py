class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        # we then check if c is in countT AND if window[c] is the same as countT[c], if so add 1 to have
        
        # finally check while have == need, EVERYTHING BELOW IS INSIDE THIS WHILE
        # if the total window (r - l + 1) LESS THAN reslen, replace res with [l, r]
        ...
        # finally, outside WHILE replace l, r pointers with the res, 
        # and return a sliced s[l : r + 1] if the reslen is not infinity, otherwise ""
